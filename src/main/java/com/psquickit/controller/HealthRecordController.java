...
public class HealthRecordController {
	...
	public @ResponseBody GetTestNameValueReportResponse addTestNameValue(
			...
			@RequestParam(value="healthRecordDate", required=false) @DateTimeFormat(pattern="yyyy-MM-dd'T'hh:mm:ssZ") ZonedDateTime healthRecordDate, //2001-10-26T21:32:52+02:00
